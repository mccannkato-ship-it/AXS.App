...
async function ticketmaster(url) { return new Response(JSON.stringify({ _embedded: { events: [] }, events: [], disabled: true, message: 'Live event search is temporarily unavailable.' }), { status: 503, headers: { 'content-type': 'application/json; charset=utf-8', 'cache-control': 'no-store' } }) }
